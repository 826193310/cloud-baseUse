...
import com.su.springcloud.alibaba.myhandler.CustomBlockHandler;
...
public class RateLimitController {
    ...
    **/
    ...
    /**
    *
    *@Description: 测试自定义类和方法限流处理，  http://localhost:8401/rateLimit/customerBlockHandler
    *@param: null
    *@Author: SGZ
    *@Date: 2020/11/9
    *@return:
    ...
    **/
    ...
    @SentinelResource(value = "customerBlockHandler", blockHandlerClass = CustomBlockHandler.class,
